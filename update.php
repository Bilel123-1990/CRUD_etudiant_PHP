...
<body>
        ...
        <div class="row pt-4">
            ...
            <form action="" method="POST" class="form-horizontal col-md-6 pt-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label>
                            <input type="radio" name="gender" id="optionsRadios" value="h"
                                <?php if($r['gender'] == 'h'){ echo "checked";} ?>>
                            H
                        </label>
                        <label>
                            <input type="radio" name="gender" id="optionsRadios" value="f"
                                <?php if($r['gender'] == 'f'){ echo "checked";} ?>>
                            F
                        </label>
    ...
    ! function(n, t) {
        "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" ==
            typeof define && define.amd ? define(t) : (n = "undefined" != typeof globalThis ? globalThis : n || self)
            .LazyLoad = t()
    }(this, (function() {
        "use strict";
        ...
        var t = "undefined" != typeof window,
            e = t && !("onscroll" in window) || "undefined" != typeof navigator &&
            ...
            C = function(n, t) {
                o ? n.classList.remove(t) : n.className = n.className.replace(new RegExp("(^|\\s+)" + t +
            ...
            on = function(n, t, e) {
                ...
                nn(i) || function(n, t, e) {
                    ...
                    ! function(n, t, e, i) {
                        var o = w(t);
                        en(t, e, i), N(t, e.class_loaded), A(t, v), O(e.callback_loaded, t, i), o ||
                            X(e, i)
                    }(0, n, t, e), tn(i)
                }), (function(o) {
                    ! function(n, t, e, i) {
                        var o = w(t);
                        en(t, e, i), N(t, e.class_error), A(t, p), O(e.callback_error, t, i), o ||
                            X(e, i)
                    }(0, n, t, e), tn(i)
                }))
            },
                ...
                ! function(n) {
                    ...
                    function(n, t, e) {
                        var i = I(n, t.data_bg),
                            ...
                            r = a && o ? o : i;
                        r && (n.style.backgroundImage = 'url("'.concat(r, '")'), M(n).setAttribute(l, r), B(n,
                            t, e))
                    }(n, t, e),
                    function(n, t, e) {
                        ...
                        r && (n.style.backgroundImage = r, function(n, t, e) {
                            N(n, t.class_applied), A(n, b), e && (t.unobserve_completed && z(n, t), O(t
                                .callback_applied, n, e))
                        }(n, t, e))
                    }(n, t, e)
            },
            rn = function(n, t, e) {
            ...
            sn = function(n, t) {
                ...
                function(n, t) {
                    L(n) || w(n) || (C(n, t.class_entered), C(n, t.class_exited), C(n, t.class_applied), C(n, t
                        .class_loading), C(n, t.class_loaded), C(n, t.class_error))
                }(n, t), k(n), $(n)
            },
            fn = ["IMG", "IFRAME", "VIDEO"],
            dn = function(n) {
                    ...
                    return function(n) {
                        ...
                        L(n) || (N(n, e.class_exited), function(n, t, e, i) {
                            e.cancel_on_exit && function(n) {
                                ...
                                }(n), un(n), C(n, e.class_loading), R(i, -1), k(n),
        ...
        return hn.prototype = {
            ...
            destroy: function() {
                this._observer && this._observer.disconnect(), vn(this._settings).forEach((function(n) {
                        $(n)
                    })), delete this._observer, delete this._settings, delete this.loadingCount,
